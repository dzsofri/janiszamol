...
def haromszogkerulet():
    ...
    sz1=Label(haromszog, text="A (cm):")
    sz2=Label(haromszog, text="B (cm):")
    sz3=Label(haromszog, text="C (cm):")
    sz4=Label(haromszog, text="Eredmény (cm):")
...
def haromszogterulet():
    ...
    gomb2=Button(haromszog, text="Kilép", command=haromszog.destroy)
    sz1=Label(haromszog, text="A (cm):")
    sz2=Label(haromszog, text="M (cm):")
    sz3=Label(haromszog, text="Eredmény (cm2):")
    m1= Entry(haromszog, width=30)
    m2= Entry(haromszog, width=30)
    m3= Entry(haromszog, width=30)
